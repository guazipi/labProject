...
class spacetrack
{
    ...
    private $auth_username = "html52014@126.com";
    private $auth_password = "nimeidecesiumorbit";
...
//            'tle_latest' => $this->base_url .'basicspacedata/query/class/tle_latest',
            'tle_latest' => $this->base_url .'basicspacedata/query/class/tle_latest/ORDINAL/1/NORAD_CAT_ID/37820/orderby/TLE_LINE1 ASC/format/3le',
    ...
    public function changeApikey($api_key,$number){
        $this->api[$api_key]=$this->base_url .'basicspacedata/query/class/tle_latest/ORDINAL/1/NORAD_CAT_ID/'.$number.'/orderby/TLE_LINE1 ASC/format/3le';
    }

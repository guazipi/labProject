    ...
    _.prototype.registerEditableShape = function (surface) {
        ...
        setListener(surface, 'mouseMove', function (position) {
            ...
            if (!surface._editMode) {
                ...
                _self._tooltip.showAt(position, "点击编辑此图形");
...
//
    ...
    var defaultBillboard = {
        iconUrl: "js/drawHelper/img/dragIcon.png",
        shiftX: 0,
        shiftY: 0
    }
    ...
    var dragHalfBillboard = {
        iconUrl: "js/drawHelper/img/dragIconLight.png",
        shiftX: 0,
        shiftY: 0
    }
        ...
        mouseHandler.setInputAction(function (movement) {
            ...
            if (position != null) {
                if (extent == null) {
                    ...
                    tooltip.showAt(position, "<p>点击开始绘制长方形</p>");
                    ...
                    if (cartesian) {
                        ...
                        tooltip.showAt(position, "<p>拖拽更改长方形的范围</p><p>再次点击结束绘制</p>");
            ...
            if (position != null) {
                if (circle == null) {
                    ...
                    if (cartesian) {
                        ...
                        tooltip.showAt(position, "<p>移动鼠标更改圆的半径</p><p>再次点击结束绘制</p>");
    ...
    _.DrawHelperWidget = (function () {
        ...
        function _(drawHelper, options) {
            ...
            var drawOptions = {
                ...
                polygonIcon: "js/drawHelper/img/glyphicons_096_vector_path_polygon.png",
                circleIcon: "js/drawHelper/img/glyphicons_095_vector_path_circle.png",
                extentIcon: "js/drawHelper/img/glyphicons_094_vector_path_square.png",
                clearIcon: "js/drawHelper/img/glyphicons_067_cleaning.png",
            ...
            addIcon('polygon', options.polygonIcon, '画多边形', function () {
            ...
            addIcon('extent', options.extentIcon, '画矩形', function () {
            ...
            addIcon('circle', options.circleIcon, '画圆形', function () {
            ...
            toolbar.appendChild(div);
            addIcon('clear', options.clearIcon, '清除所选的多边形', function () {
                ...
                for (var i = 0; i < length; i++) {
                    if ("_editMode" in viewer.scene.primitives.get(i)) {
                        if (viewer.scene.primitives.get(i)._editMode) {
                            //alert(scene.primitives.get(i)._editMode);
                ...
                for (var i = 0; i < length1; i++) {
                    //viewer.scene.primitives.get(i).destroy() ;
                    //alert(viewer.scene.primitives.contains(Cesium.BillboardCollection()));

                    //console.log(scene.primitives.get(i));
                    //console.log(scene.primitives);
                    var boolan = primitives._primitives[i].hasOwnProperty("_billboards");
                    //alert(boolan);
                    //if (viewer.scene.primitives._primitives[i]=="nt"){
                    //    alert("   ");
                    //}
                    if (boolan) {
                        if (primitives._primitives[i]._billboards && primitives._primitives[i]._billboards.length > 0) {
                            //if ("_imageId" in viewer.scene.primitives.get(i)._billboards[0]) {
                            var imageId = primitives._primitives[i]._billboards[0]._imageId;
                            if (imageId) {

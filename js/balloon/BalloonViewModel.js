...
define([
    ...
    var BalloonViewModel = function(scene, balloonElement, container) {
        ...
        if (!Cesium.defined(balloonElement)) {
            throw new Cesium.DeveloperError('balloonElement is required.');
        }

        this._scene = scene;
        this._container = Cesium.defaultValue(container, document.body);
        this._balloonElement = balloonElement;
        this._content = '';
        this._position = undefined;
        this._updateContent = false;
        this._timerRunning = false;
        this._defaultPosition = new Cesium.Cartesian2(this._container.clientWidth, this._container.clientHeight / 2);
            ...
            if (this._updateContent) {
                ...
                if (wasShowing) {
                    ...
                    setTimeout(function() {
                        ...
                        if (Cesium.defined(that._position)) {
    ...
    defineProperties(BalloonViewModel.prototype, {
        ...
        container : {
            ...
            set : function(value) {
                if (!(value instanceof Element)) {
                    throw new Cesium.DeveloperError('value must be a valid Element.');
                }
        ...
        defaultPosition : {
            ...
            set : function(value) {
                this._defaultPosition = Cesium.Cartesian2.clone(value, this._defaultPosition);
            }
        },
        /**
